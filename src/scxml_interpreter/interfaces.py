...
class ContainerStateInterface(SimpleStateInterface):
    def __init__(self, identifier, data={}, transitions={}, states=[], onentry={}, onexit={}):
        SimpleStateInterface.__init__(self, identifier, data, transitions, onentry, onexit)
...
class CompoundStateInterface(ContainerStateInterface):
    def __init__(self, identifier, data={}, transitions={}, states=[], initial_state_id="", onentry={}, onexit={}):
        ContainerStateInterface.__init__(self, identifier, data, transitions, states, onentry, onexit)
...
class ParallelStateInterface(ContainerStateInterface):
    def __init__(self, identifier, data={}, default_outcome=None, outcome_map=[], transitions={}, states=[], onentry=[], onexit=[]):
        ContainerStateInterface.__init__(self, identifier, data, transitions, states, onentry, onexit)
